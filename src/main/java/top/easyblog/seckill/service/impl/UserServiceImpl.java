...
import top.easyblog.seckill.model.mapper.UserDOMapper;
import top.easyblog.seckill.model.mapper.UserPasswordDOMapper;
...
public class UserServiceImpl implements UserService {
    ...
    public UserModel getUserByIdInCache(Integer userId) {
        ...
        if(userModel==null){
            ...
            redisService.set(USER_VALIDATE_PREFIX + userId,JSON.toJSONString(userModel),1800, RedisService.RedisDataBaseSelector.DB_0);
        }
        return userModel;
    }
